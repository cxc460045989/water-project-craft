...
class MockInstrumentSimulator(QObject):
    ...
    def _handle_4byte_cmd(self, data):
        ...
        if data[1] != 0x4D:
            if data[1] == 0x57:
                ...
                return bytes([0x4F, 0x4B, data[2], data[3], data[4], 0x45, 0x4E, 0x44])
            elif data[1] == 0x58:
                return bytes([0x4F, 0x4B, data[2], data[3], data[4], 0x45, 0x4E, 0x44])
            return b""
    ...
    def validate_protocol(self):
        ...
        expected_temp = bytes([0x4F, 0x4B, 1, 0, 5, 0x45, 0x4E, 0x44])
        ...
        expected_weight = bytes([0x4F, 0x4B, 0, 0, 1, 0x45, 0x4E, 0x44])
